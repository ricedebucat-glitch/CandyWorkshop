...
public interface IContents {
    ...
    enum Type implements StringRepresentable {
        ...
        GLAZER("glazer", 3, 1, ItemRegistry.GLAZER_CONTENTS_DCTYPE),
        ;
        ...
        Type(String name, int size, int tierMarch, Supplier<DataComponentType<GummyContents>> dataComponentType) {
            this.name = name;
            this.size = size;
